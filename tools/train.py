...
def main():
    ...
    zilong_schedule = None
    zilong_step = None
    if cfg.MODEL.TRAIN.OPTIMIZATION.OPTIMIZER == 'adam' and 'zilong_schedule' in cfg.MODEL.TRAIN.OPTIMIZATION.keys():
        zilong_schedule = cfg.MODEL.TRAIN.OPTIMIZATION.zilong_schedule
        zilong_step = cfg.MODEL.TRAIN.OPTIMIZATION.zilong_step
        
    #if 'zilong_schedule' in cfg.MODEL.TRAIN.OPTIMIZATION:
    train_model(
        model,
        optimizer,
        train_loader,
